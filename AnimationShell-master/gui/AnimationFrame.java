...
public class AnimationFrame extends JFrame {
	...
	protected void updateControls() {
		...
		this.lblTop.setText(String.format("Time: %9.3f;  scale: %3.3f; canSlide: %b; health: %2d; score: %3d", total_elapsed_time / 1000.0, scale, PenguinSprite.canSlide(), PenguinSprite.getHealth(), PenguinSprite.getFishCollected()));
		if (universe != null) {
